...
;  COPY_STRUCT is used to copy, first from struct_array2 then from struct_array1.
;
; MODIFICATION HISTORY:
;  04-June-2004: created, E. Sheldon, UofChicago
;  2006-10-06: Now preserves name order.  Also, when structs have the exactly same
;      tags, struct1 is returned. Renamed to combine_structs because it
;      completely subsumes the functionality of that program.
;-
;
;
;
...
pro combine_structs, struct_array1, struct_array2, newstruct, $
                      structyp=structyp

  if n_params() lt 2 then begin 
      print,'-Syntax: combine_dstructs, struct1, struct2, new_struct'
      print
